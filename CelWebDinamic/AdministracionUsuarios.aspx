<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AdministracionUsuarios.aspx.cs" Inherits="CelWebDinamic.AdministracionUsuarios" %>
                        ...
                        <%-- Grid --%>
                         ...
                         <div class="row" style="margin-top:15px"> 
                              <div class="col-md-4" style="margin-top: 10px">
                                ...
                                <div class="input-group">
                                    <asp:TextBox runat="server" TextMode="Search" ID="txtBusqueda" MaxLength="20"  CssClass="form-control" OnTextChanged="txtBusqueda_TextChanged" AutoPostBack="true"/>
                                    <asp:LinkButton runat="server" ID="lnkBusqueda" CssClass="btn btn-primary" OnClick="lnkBusqueda_Click">
